                    ...
                    <>
                        <div className=' my-5 '>
                            ...
                            <div className=' flex justify-between my-4'>
                                ...
                                <button onClick={() => sendWhatsAppMessage({ phoneNumber: bio?.contactDetails?.whatsappNo, message: 'we love you', biodataUrl: `${qrScanLink}/${bio?._id}`})} className='btn   therd-btn'> <IoLogoWhatsapp size={15} /> <p>{labels?.whatsapp}</p> </button>
                            </div>
